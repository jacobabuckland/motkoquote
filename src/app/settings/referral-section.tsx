...
// REF-4: the referrer's +3, rising to 5, unlocks when the referred trade SENDS
// THEIR FIRST QUOTE — not when they land their first paid job. A tighter loop:
// the reward arrives on day one rather than weeks later, and it turns on
// something the referred trade actually controls.
  ...
  return (
    <section>
      ...
      <p className="mb-3 text-sm text-text-secondary">
        Share your code with another trade. You get 3 free jobs as soon as they
        send their first quote with Motko (rising to 5 at 5 activated
        referrals).
      </p>
