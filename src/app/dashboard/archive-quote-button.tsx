...
export const ArchiveQuoteButton = ({ quoteId }: { quoteId: string }) => {
  ...
  return (
    <button
      ...
      className="inline-flex min-h-11 items-center text-sm font-medium text-ink-secondary underline underline-offset-4 transition-colors duration-150 hover:text-ink active:text-ink disabled:text-ink-muted"
    >
