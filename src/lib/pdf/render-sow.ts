...
// Shared by the SOW-PDF download route, mirroring render-quote.ts and
// render-contract.ts's pattern.
export const renderSowPdf = async (jobId: string): Promise<Buffer | null> => {
