...
export const businessSetupStateSchema = z.object({
  ...
  half_day_rate: z.number().nullable().default(null),
...
export const businessSetupDeltaSchema = z.object({
  ...
  half_day_rate: z.number().optional(),
...
export const BUSINESS_SETUP_DELTA_TOOL_PARAMETERS = {
  ...
  properties: {
    ...
    half_day_rate: {
      type: "number",
      description: "What they charge for half a day in GBP, if they do half days.",
    },
...
export const mergeBusinessSetupDelta = (
  ...
  return {
    ...
    half_day_rate: delta.half_day_rate ?? base.half_day_rate,
